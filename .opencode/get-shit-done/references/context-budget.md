...
The keys live in `.claude/settings.json` (project) or `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
