...
INSTALL_JS_GLOBAL="/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
