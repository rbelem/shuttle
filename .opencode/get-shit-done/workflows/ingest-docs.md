...
```bash
INIT=$(node "/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
