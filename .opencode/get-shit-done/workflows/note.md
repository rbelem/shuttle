...
- **Global scope**: `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/notes/`)
...
2. Glob `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/notes/` — works in any directory
