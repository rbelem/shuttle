...
```
Agent(
  prompt="Read /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/templates/SECURITY.md`
