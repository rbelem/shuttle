...
<required_reading>
@/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/references/ai-frameworks.md
@/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/agents/gsd-eval-planner.md for instructions.
