...
```bash
INIT=$(node "/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/rodrigo/Workspace/github.com/rbelem/shoot/.opencode/get-shit-done/templates/spec.md.
