...
///
/// The check is the conservative default ([`BOOT_HEALTH_EXEC`]); the
/// per-image DSL surface is a follow-up ticket.
pub(crate) fn boot_health_service_content() -> String {
    format!(
        "\
# Generated by shuttle — do not edit.
[Unit]
...
pub(crate) fn emit_boot_assessment(root: &Path) -> miette::Result<()> {
    crate::emit::write_unit(
        root,
