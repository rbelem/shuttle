...
```
pkgs/
  main/                   # Component (main = canonical/official)
...
Debian/Ubuntu convention (e.g. `libssl` → `pkgs/main/libl/libssl/`).

## Finding packages

```
pkgs/main/j/jq/shoot.lua        # package: jq
pkgs/main/h/hello/shoot.lua     # package: hello
```
...
```bash
mkdir -p pkgs/main/<first-letter>/<package>
vim pkgs/main/<first-letter>/<package>/shoot.lua
```
